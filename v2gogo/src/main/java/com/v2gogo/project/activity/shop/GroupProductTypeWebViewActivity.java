...
public class GroupProductTypeWebViewActivity extends BaseActivity implements IonReceiveTitleCallback, IonItemClickCallback
{
	...
	private static GroupProductTypeWebViewActivity instance;
	...
	protected void onInitLoadDatas()
	{
		...
		mWebView.loadUrl(url);
		// mWebView.loadUrl("http://192.168.1.8:9999/product/saleList?typeId=47aa1fa37b6a48f2b8ff825db070d58d");
	}
	...
	public static GroupProductTypeWebViewActivity getInstance()
	{
		if (instance == null)
		{
			instance = new GroupProductTypeWebViewActivity();
		}
		return instance;
	}
	...
	private void clickBack()
	{
		if (isBackHome)
		{
			...
			{
				Intent intent = new Intent(GroupProductTypeWebViewActivity.this, MainTabActivity.class);
				startActivity(intent);
				finish();
			}
		}
