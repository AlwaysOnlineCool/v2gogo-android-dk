 ...
 * @author houjun
 */
public class CustomMaterialProgress extends View
{
	...
	public CustomMaterialProgress(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		parseAttributes(context.obtainStyledAttributes(attrs, R.styleable.ProgressWheel));
	}

	public CustomMaterialProgress(Context context)
	{
		super(context);
	}
