...
public class CustomMaterialDialog
{
	...
	private CustomMaterialDialog.Builder mBuilder;
	private View mView;
	...
	public CustomMaterialDialog setBackgroundResource(int resId)
	{
	...
	public CustomMaterialDialog setTitle(int resId)
	{
		mTitleResId = resId;
		if (mBuilder != null)
		{
	...
	public CustomMaterialDialog setTitle(CharSequence title)
	{
		mTitle = title;
		if (mBuilder != null)
		{
	...
	public CustomMaterialDialog setMessage(int resId)
	{
		mMessageResId = resId;
		if (mBuilder != null)
		{
	...
	public CustomMaterialDialog setMessage(CharSequence message)
	{
		mMessage = message;
		if (mBuilder != null)
		{
	...
	public CustomMaterialDialog setPositiveButton(int resId, final View.OnClickListener listener)
	{
	...
	public CustomMaterialDialog setPositiveButton(String text, final View.OnClickListener listener)
	{
		mPositiveButton = new Button(mContext);
		LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT);
		mPositiveButton.setLayoutParams(params);
	...
	public CustomMaterialDialog setNegativeButton(int resId, final View.OnClickListener listener)
	{
	...
	public CustomMaterialDialog setNegativeButton(String text, final View.OnClickListener listener)
	{
		mNegativeButton = new Button(mContext);
		mLayoutParams = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT);
		mNegativeButton.setLayoutParams(mLayoutParams);
	...
	public CustomMaterialDialog setCanceledOnTouchOutside(boolean cancel)
	{
		this.mCancel = cancel;
		if (mBuilder != null)
		{
