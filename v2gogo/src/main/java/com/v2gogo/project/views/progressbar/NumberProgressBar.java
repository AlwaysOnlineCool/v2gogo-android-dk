package com.v2gogo.project.views.progressbar;
...
public class NumberProgressBar extends View
{
	...
	private int mReachedBarColor;// reached显示颜色

	private int mUnreachedBarColor;// unreached显示颜色

	private int mTextColor;// 字体颜色

	private float mTextSize;// 字体大小

	private float mReachedBarHeight;// reached的高度

	private float mUnreachedBarHeight;// unreached的高度

	private String mSuffix = "%";// 进度的后缀

	private String mPrefix = "";// 进度的前缀
	...
	public NumberProgressBar(Context context, AttributeSet attrs, int defStyleAttr)
	{
		...
		default_reached_bar_height = DensityUtil.dp2px(context, 1.5f);
		default_unreached_bar_height = DensityUtil.dp2px(context, 1.0f);
		default_text_size = DensityUtil.sp2px(context, 10);
		default_progress_text_offset = DensityUtil.dp2px(context, 3.0f);
