 ...
 * @author houjun
 */
public class AppNoticeDialog extends Dialog implements android.view.View.OnClickListener
{
	...
	public AppNoticeDialog(Context context, boolean cancelable, OnCancelListener cancelListener)
	{
	...
	public void setSureTipAndMessage(String message,String sureString)
	{
		if (mBtnSure != null)
		{
			mBtnSure.setText(sureString);
